...
const mastodon_logo = await
  FileAttachment("/images/mastodon-logo-purple.png")
  .url()
...
export class MastodonComments extends HTMLElement {
  constructor() {
    super();
        ...
        <div style="display: flex; justify-content: space-between; align-items: center">
          <div>
            <a class="link" target="_blank"
              href="https://${this.host}/@${this.user}/${this.tootId}">
                Add comment
            </a>
          </div>
          <div>
            <img width="100px" height="100px" src="${mastodon_logo}">
          </div>
        </div>
      </div>
...
// Removed this from dynamically generated HTML above:
// <div class="status">
...
// </div>
    ...
    div.innerHTML = DOMPurify.sanitize(mastodonComment.trim());
      ...
      // I deleted this and added the sanitize command directly,
      // since I guess I *want* to do it.
